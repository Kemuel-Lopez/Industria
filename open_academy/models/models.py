...
class Course(models.Model):
    ...
    description = fields.Text("Descripción del Curso")
...
class Session(models.Model):
    ...
    end_date = fields.Date(string="Día de Finalización",
                           store=True,
    ...
    def _verify_valid_seats(self):
        if self.seats < 0:
            return {
                'warning': {
                    'title': _("Valor de ASIENTOS incorrecto"),
                    'message': _("El número de asientos disponibles no puede ser negativo"),
                },
            }
